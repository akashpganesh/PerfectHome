...
?>
        ...
        <h1 align="center" id="heading">Rent Report</h1>
        <br><br>
       ...
       <center>
        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            include("../Assets/Connection/connection.php");
                     ...
                     {
                        $selQry= "select * from tbl_rentrequest r inner join tbl_house h,tbl_user u where r.house_id=h.house_id and r.user_id=u.user_id and rentreq_date between '".$_POST["fdate"]."' and '".$_POST["tdate"]."'";
                     }else{

                     $selQry= "select * from tbl_rentrequest r inner join tbl_house h,tbl_user u where r.house_id=h.house_id and r.user_id=u.user_id";
                     }
			...
			?>
              <tr>
                 ...
                 <td align="center"><?php echo $data["house_name"]; ?></td>
                 <td align="center"><?php echo $data["user_name"]; ?></td>
                 <td align="center"><?php echo $data["rentreq_date"]; ?></td>
                 <td align="center"><?php 

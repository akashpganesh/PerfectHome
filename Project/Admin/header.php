...
<head>
  ...
  <!-- Vendor CSS Files -->
  <link href="../Assets/Templates/Admin/assets/vendor/animate.css/animate.min.css" rel="stylesheet">
  ...
  <link href="../Assets/Templates/Admin/assets/vendor/swiper/swiper-bundle.min.css" rel="stylesheet">
                    ...
                    <ul class="menu">
                        ...
                        <li class="sidebar-item  has-sub">
                            ...
                            <ul class="submenu ">
                                ...
                                <li class="submenu-item ">
                                    <a href="AcceptedUsers.php">Accepted Users</a>
                                </li>
                                <li class="submenu-item ">
                                    <a href="RejectedUsers.php">Rejected Users</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="sidebar-item  has-sub">
                            ...
                            <ul class="submenu ">
                                <li class="submenu-item ">
                                    <a href="OwnerList.php">Owners List</a>
                                </li>
                                <li class="submenu-item ">
                                    <a href="AcceptedOwners.php">Accepted Owners</a>
                                </li>
                                <li class="submenu-item ">
                                    <a href="RejectedOwners.php">Rejected Owners</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="sidebar-item  has-sub">
                            ...
                            <ul class="submenu ">
                                <li class="submenu-item ">
                                    <a href="HouseType.php">House Type</a>
                                </li>
                                <li class="submenu-item ">
                                    <a href="RentHousesList.php">Rent Houses List</a>
                                </li>
                                <li class="submenu-item ">
                                    <a href="LeaseList.php">Lease Houses List</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="sidebar-item  has-sub">
                            ...
                            <ul class="submenu ">
                                <li class="submenu-item ">
                                    <a href="Report1.php">Rent Report</a>
                                </li>
                                <li class="submenu-item ">
                                    <a href="Report2.php">Lease Report</a>
                                </li>
                        ...
                        <li class="sidebar-item  has-sub">
                            ...
                            <ul class="submenu ">
                                <li class="submenu-item ">
                                    <a href="RentComplaints.php">Complaint About Rent House Owners</a>
                                </li>
                                <li class="submenu-item ">
                                    <a href="LeaseComplaints.php">Complaint About Lease House Owners</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="sidebar-item  has-sub">
                            ...
                            <ul class="submenu ">
                                <li class="submenu-item ">
                                    <a href="UserFeedbacks.php">User Feedback</a>
                                </li>
                                <li class="submenu-item ">
                                    <a href="OwnerFeedbacks.php">Owner Feedback</a>
                                </li>

...
?>
        ...
        <h1 align="center" id="heading">Lease Report</h1>
        <br><br>
       ...
       <center>
        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            include("../Assets/Connection/connection.php");
                     ...
                     {
                        $selQry= "select * from tbl_leaserequest r inner join tbl_lease l,tbl_user u where r.lease_id=l.lease_id and r.user_id=u.user_id and leasereq_date between '".$_POST["fdate"]."' and '".$_POST["tdate"]."'";
                     }else{

                     $selQry= "select * from tbl_leaserequest r inner join tbl_lease l,tbl_user u where r.lease_id=l.lease_id and r.user_id=u.user_id";
                     }
			...
			?>
              <tr>
                 ...
                 <td align="center"><?php echo $data["leasereq_date"]; ?></td>
                 <td align="center"><?php 

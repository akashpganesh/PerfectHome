...
if(isset($_GET["did"]))
{
  ...
  if($conn->query($delQry))
  {
    ?>
        <script>
    alert("Deleted");
    window.location="AcceptedUsers.php";
    </script>
        <?php
  }
  else
...
<section class="section">
    ...
    <?php
  $selectqry="select * from tbl_user u inner join tbl_place p inner join tbl_district d where u.place_id=p.place_id AND p.dist_id=d.dist_id AND user_status=1";

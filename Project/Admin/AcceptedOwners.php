...
if(isset($_GET["did"]))
{
  ...
  if($conn->query($delQry))
  {
    ?>
        <script>
    alert("Deleted");
    window.location="AcceptedOwners.php";
    </script>
        <?php
  }
  else
...
<section class="section">
    ...
    <?php
  $selectqry="select * from tbl_owner o inner join tbl_place p inner join tbl_district d where o.place_id=p.place_id AND p.dist_id=d.dist_id AND owner_status=1";

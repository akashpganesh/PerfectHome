...
if(isset($_POST["btn_submit"]))
{
	...
	$path=$_FILES["file_agreement"]["tmp_name"];
	 ...
	 $updateqry="UPDATE tbl_agreement SET agreement_file='".$agreement."',agreement_fromdate='".$fromdate."',agreement_todate='".$todate."' where renter_id='".$renterid."'";
	 if($conn->query($updateqry))
  {
    ?>
        <script>
    alert("INSERTED");
    window.location="RenewRentAgreement.php";
    </script>
        <?php
  }
  else

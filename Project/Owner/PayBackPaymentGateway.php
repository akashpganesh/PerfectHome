...
{
$updateqry="update tbl_lease set lease_status=1,lease_paymentstatus=1 where lease_id='".$leaseid."'";
	$updateqry2="update tbl_leaseholder set leaseholder_status=1 where leaseholder_id='".$leaseholderid."'";
	 if($conn->query($updateqry)&&$conn->query($updateqry2))
  {
    ?>
        <script>

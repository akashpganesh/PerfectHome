...
{
  $selectqry="select * from tbl_rentrequest where rentreq_status=1 and house_id='".$_POST["hidden_houseid"]."'";
  $row=$conn->query($selectqry);
    ...
    window.location="RentRequestMain.php";
    </script>
        <?php
  }else{
...
<section class="section">
  ...
  <tr>
    ...
    <th width="46"><div align="center">User Name</div></th>
    <th width="46"><div align="center">House Name</div></th>
    ...
    <th width="56" colspan="2"><div align="center">Status</div></th>
                                ...
                                <tbody>
    <?php
	$selQry="select*from tbl_rentrequest r inner join tbl_user u,tbl_house h where r.user_id=u.user_id AND r.house_id=h.house_id and h.owner_id='".$ownerid."'";
  ...
  <tr>
    ...
    <td><div align="center"><a href="RentRequestMain.php?oid=<?php echo $data["rentreq_id"];?>">View Details</a></div></td>
    <input type="hidden" name="hidden_id" value="<?php echo $data["rentreq_id"]; ?>">
    <input type="hidden" name="hidden_houseid" value="<?php echo $data["house_id"]; ?>">

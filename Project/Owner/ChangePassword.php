...
$selectqry="select * from tbl_owner where owner_id='".$ownerid."'"; 
...
$pass=$data["owner_password"];
      ...
      {
    $updateqry="UPDATE tbl_owner SET owner_password = '".$password."' WHERE owner_id = '".$ownerid."'" ;
...
<form id="form1" name="form1" method="post" action="">
  ...
  <tr>
      ...
      <td><label for="txt_oldpassword"></label>
        <input type="text" name="txt_oldpassword" id="txt_oldpassword" required/></td>
    </tr>
    <tr>

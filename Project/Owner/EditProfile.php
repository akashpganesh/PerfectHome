...
$updateqry="UPDATE tbl_owner SET owner_name = '".$ownername."',owner_gender = '".$gender."',owner_contact = '".$contact."',owner_email = '".$email."',place_id = '".$place."',owner_photo = '".$photo."' WHERE owner_id = '".$ownerid."'";
...
<?php
 $selectqry="select * from tbl_owner o inner join tbl_place p inner join tbl_district d where owner_id='".$ownerid."' AND o.place_id=p.place_id AND p.dist_id=d.dist_id";
  ...
  <table width="400" border="1">
    ...
    <tr>
      <td colspan="2"><div align="center">
        <input type="submit" name="btn_update" id="btn_update" value="Update" /><br>

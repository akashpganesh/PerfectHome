...
if(isset($_GET["did"]))
{
  ...
  if($conn->query($delQry))
  {
    ?>
        <script>
    alert("Deleted");
    window.location="LeaseGallary.php";
    </script>
        <?php
  }
  else
...
<section class="section">
    ...
    <tr>
      ...
      <td>Action</td>
                                ...
                                <tbody>
    <?php
    $selectqry="select * from tbl_housegallary where lease_id='".$leaseid."'";
  ...
  while($data=$row->fetch_assoc())
  {
    ...
    <tr>
      ...
      <td><a href="LeaseGallary.php?did=<?php echo $data["gallary_id"];?>">Delete</a></td>
    </tr>
    <?php
  }
  ?>

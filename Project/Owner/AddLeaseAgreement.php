...
if(isset($_POST["btn_submit"]))
{
	...
	$path=$_FILES["file_agreement"]["tmp_name"];
	 ...
	 $insertqry="INSERT INTO tbl_agreement(agreement_file,agreement_fromdate,agreement_todate,leaseholder_id)VALUES('".$agreement."','".$fromdate."','".$todate."','".$leaseholderid."')";
	 ...
	 if($conn->query($insertqry))
  {
    ?>
        <script>
    alert("INSERTED");
    window.location="AddLeaseAgreement.php";
    </script>
        <?php
  }
  else

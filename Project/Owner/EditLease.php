...
if(isset($_POST["btn_submit"]))
{
	 ...
	 $updateqry="UPDATE tbl_lease(lease_name='".$housename."',lease_address='".$address."',place_id='".$place."',lease_amount='".$price."',lease_advance='".$advance."',lease_photo='".$photo."',type_id='".$housetype."',lease_landmark='".$landmark."',lease_facilities='".$facilities."',lease_cent='".$totarea."',lease_maxyear='".$maxyear."',lease_contact='".$contact."' where lease_id='".$leaseid."'";
...
<form action="" method="post" enctype="multipart/form-data" name="form1" id="form1">
  <table width="532" height="577" border="1">
    <tr>
    ...
    <tr>
      <td>Facilities</td>
      <td><textarea name="txt_facilities" id="txt_facilities" cols="45" rows="5" required></textarea></td>
    </tr>
    <tr>
      <td>Contact No</td>

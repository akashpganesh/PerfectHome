...
if(isset($_POST["btn_submit"]))
{
	 ...
	 $insertqry="INSERT INTO tbl_agreement(agreement_file,agreement_fromdate,agreement_todate,renter_id)VALUES('".$agreement."','".$fromdate."','".$todate."','".$renterid."')";
	 ...
	 if($conn->query($insertqry))
  {
    ?>
        <script>
    alert("INSERTED");
    window.location="AddRentAgreement.php";
    </script>
        <?php
  }
  else

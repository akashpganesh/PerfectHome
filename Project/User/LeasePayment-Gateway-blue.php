...
{	
$updateqry="UPDATE tbl_leaserequest SET leasereq_status2 = 1 where user_id='".$userid."' AND lease_id='".$leaseid."' ";
$insertqry="INSERT INTO tbl_leaseholder(user_id,lease_id)VALUES('".$userid."','".$leaseid."')";
$updateqry2="UPDATE tbl_lease SET lease_status = 3 where lease_id='".$leaseid."'";
echo $updateqry2;
if($conn->query($insertqry)&&$conn->query($updateqry)&&$conn->query($updateqry2))
{
?>
<script>

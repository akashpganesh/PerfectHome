...
$row=$conn->query($selQry);
  ...
  while($data=$row->fetch_assoc())
  {
    $i++;
	 /* ?>
      <td>
      <p align="center"><img src="../Assets/Files/House/<?php echo $data["lease_photo"]; ?>" width="120" height="120"></p>
        <p>House Name : <?php echo $data["lease_name"]; ?></p>
      <p>Owner Name : <?php echo $data["owner_name"]; ?></p>
      <p>House Type : <?php echo $data["type_name"]; ?></p>
      <p>Place : <?php echo $data["place_name"]; ?></p>
      <p align="center"><a href="LeaseSearch.php?oid=<?php echo $data["lease_id"];?>">open</a></p> </td>
    <?php
	if($i==4) 
	{
		echo "</tr><tr>";
  ...
  */?><!--<div class="col-md-4">
            <div class="card-box-a card-shadow">
              <div class="img-box-a">
                <img src="../Assets/Files/House/<?php echo $data["lease_photo"]; ?>" alt="" class="img-a img-fluid">
              </div>
              <div class="card-overlay">
                <div class="card-overlay-a-content">
                  <div class="card-header-a">
                    <h2 class="card-title-a">
                      <a href="RentSearch.php?oid=<?php echo $data["lease_id"];?>"><?php echo $data["lease_name"]; ?></a>
                    </h2>
                  </div>
                  <div class="card-body-a">
                    <div class="price-box d-flex">
                      <span class="price-a">lease | <?php echo $data["lease_amount"];?></span>
                    </div>
                    <a href="LeaseSearch.php?oid=<?php echo $data["lease_id"];?>" class="link-a">Click here to view
          ...
          <div class="property-entry h-100">
              <a href="LeaseSearch.php?oid=<?php echo $data["lease_id"];?>" class="property-thumbnail">
                <div class="offer-type-wrap">
                  <!--<span class="offer-type bg-danger">Sale</span>
                  <span class="offer-type bg-success">Rent</span>-->
                </div>
                <img src="../Assets/Files/House/<?php echo $data["lease_photo"]; ?>" alt="Image" class="img-fluid">
              </a>
              <div class="p-4 property-body">
                <a href="LeaseSearch.php?oid=<?php echo $data["lease_id"];?>" class="property-favorite"><span class="icon-heart-o"></span></a>
                <h2 class="property-title"><a href="LeaseSearch.php?oid=<?php echo $data["lease_id"];?>"><?php echo $data["lease_name"]; ?></a></h2>
                <span class="property-location d-block mb-3"><span class="property-icon icon-room"></span><?php echo $data["lease_address"];?></span>
                <strong class="property-price text-primary mb-3 d-block text-success">&#8377; <?php echo $data["lease_amount"];?></strong>
                <ul class="property-specs-wrap mb-3 mb-lg-0">
                  <li>
                    <span class="property-specs">Beds</span>
                    <span class="property-specs-number"><?php echo $data["lease_beds"]; ?> <sup>+</sup></span>
                    
                  </li>
                  <li>
                    <span class="property-specs">Baths</span>
                    <span class="property-specs-number"><?php echo $data["lease_baths"]; ?></span>
                    
                  </li>
                  <li>
                    <span class="property-specs">SQ FT</span>
                    <span class="property-specs-number"><?php echo $data["lease_cent"]; ?></span>

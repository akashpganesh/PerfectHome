...
if(isset($_POST["btn_sent"]))
{
	...
	$insertqry="INSERT INTO tbl_complaint(complaint_type,complaint_discription,renter_id)VALUES('".$type."','".$discription."','".$renterid."')";
	 ...
	 if($conn->query($insertqry))
  {
    ?>
        <script>
    alert("INSERTED");
    window.location="HouseComplaint.php";
    </script>
        <?php
  }
  else
...
<option value="2">Complaint About Owner</option>
    ...
    <tr>
      <td colspan="2"><div align="center"><br>
        <input type="submit" name="btn_sent" id="btn_sent" value="Submit" class="button"/>
      </div></td>
    </tr>
  </table>
  <p>&nbsp;</p>
  ...
  <section class="ftco">
    ...
    <tr>
      ...
      <th scope="col">Complaint Reply</th>
						  ...
						  <tbody>
    <?php
	$selectqry="select * from tbl_complaint where renter_id='".$renterid."'";
